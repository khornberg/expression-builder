...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:"",emptyText:"Pass options to select type",typeComponent:"expression-builder-select",valueComponent:"expression-builder-select",operatorComponent:"expression-builder-select",id:Ember.computed(function(){return Ember.guidFor(Ember.getProperties(this,"type","value"))}),hasType:Ember.computed("type",function(){return Ember.getWithDefault(this,"type",!1)}),hasValue:Ember.computed("value",function(){return Ember.getWithDefault(this,"value",!1)}),hasOptions:Ember.computed(function(){return Ember.isPresent(Ember.get(this,"optionKeys"))}),optionKeys:Ember.computed("options",function(){return Object.keys(Ember.getWithDefault(this,"options",[]))}),typeOptions:Ember.computed("options",function(){return[{text:"Select type",disabled:!0}].concat(this.formatForSelect(Ember.get(this,"optionKeys")))}),valueOptions:Ember.computed("type",function(){var e=[{text:"Select value",disabled:!0}],t=Ember.get(this,"options")[Ember.get(this,"type")]
...
this.setBlockProperties(t[i],e)}},add:function(){Ember.get(this,"blocks").pushObject({})}}})}),define("expression-builder/components/expression-result",["exports","expression-builder/templates/components/expression-result"],function(e,t){"use strict"
...
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"cGBwaxQi",block:'{"statements":[[11,"div",[]],[15,"class","expression-builder"],[13],[0,"\\n  "],[11,"div",[]],[15,"class","expression-blocks"],[13],[0,"\\n"],[6,["each"],[[28,["blocks"]]],null,{"statements":[[0,"    "],[1,[33,["expression-block"],null,[["options","operators","update","block"],[[28,["options"]],[28,["operators"]],[33,["action"],[[28,[null]],"update"],null],[28,["block"]]]]],false],[0,"\\n"]],"locals":["block"]},null],[6,["if"],[[28,["hasOptions"]]],null,{"statements":[[0,"    "],[1,[33,["component"],[[28,["addComponent"]]],[["add"],[[33,["action"],[[28,[null]],"add"],null]]]],false],[0,"\\n"]],"locals":[]},null],[0,"  "],[14],[0,"\\n  "],[1,[33,["component"],[[28,["resultComponent"]]],[["expression"],[[28,["expression"]]]]],false],[0,"\\n"],[14],[0,"\\n"]],"locals":[],"named":[],"yields":[],"hasPartials":false}',meta:{moduleName:"expression-builder/templates/components/expression-builder.hbs"}})}),define("expression-builder/templates/components/expression-result",["exports"],function(e){"use strict"
